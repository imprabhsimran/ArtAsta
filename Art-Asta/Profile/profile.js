...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    async function loadProfile(userId, role) {
        try {
            ...
            if (role === 'Artist') {
                // Fetch data from the Artist collection
        ...
        profileContainer.innerHTML = `
            <div class="profile-card">
                ...
                ${profileData.role === 'Artist' ? `
                    ...
                    <a href="View-my-auctions/view-my-postings.html">View My Auction Postings</a>` : ''}
                ${profileData.role === 'Art Enthusiast' ? `
                    <a href="View-my-aod-requests/view-my-requests.html">View My Art-on-Demand Requests</a> ` : ''}
            </div>
        `;
    }
