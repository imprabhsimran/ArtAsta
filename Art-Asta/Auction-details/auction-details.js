    ...
    if (placeBidButton) {
        placeBidButton.addEventListener('click', () => {
            placeBid(auctionId, auctionIndex).then(() => {
                // Redirect to the same page with auction details after placing bid
                window.location.href = `/auction-details/auction-details.html?id=${auctionId}&check=${auctionIndex}`;
            });
        });
    } else {
